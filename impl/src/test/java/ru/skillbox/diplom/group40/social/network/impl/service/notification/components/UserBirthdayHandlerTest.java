...
public class UserBirthdayHandlerTest {
    ...
    void getEventNotificationList() {
        ...
        UserBirthdayHandler userBirthdayHandler = getNewUserBirthdayHandler();
        ...
        notificationDTO.setNotificationType(Type.USER_BIRTHDAY);
        ...
        List<EventNotification> listEventNotifications = userBirthdayHandler.getEventNotificationList(notificationDTO);
        ...
        for (EventNotification eventNotification : listEventNotifications) {
            ...
            assertThat(eventNotification).hasFieldOrPropertyWithValue("notificationType", Type.USER_BIRTHDAY);
    ...
    void getType() {
        Assertions.assertEquals(getNewUserBirthdayHandler().myType(), Type.USER_BIRTHDAY);}

    private UserBirthdayHandler getNewUserBirthdayHandler() {
        UserBirthdayHandler userBirthdayHandler = new UserBirthdayHandler(notificationSettingsService, notificationsMapper);
